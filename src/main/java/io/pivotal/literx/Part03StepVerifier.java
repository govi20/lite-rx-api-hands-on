...
//========================================================================================
	...
	void expectFooBarError(Flux<String> flux) {
		StepVerifier.create(flux)
				.expectNext("foo" ,"bar").expectError(RuntimeException.class);
	}
...
//========================================================================================
	...
	void expect10Elements(Flux<Long> flux) {
		Duration verify = StepVerifier.create(flux).expectNextCount(10).expectComplete().verify();
		System.out.println(verify.getNano());
	}
